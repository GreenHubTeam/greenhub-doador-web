import { Box, Button, IconButton, TextField, Typography, InputAdornment, Chip, Grid2  } from "@mui/material";
import { HeaderComponent } from "../Components/Header";
import HomeIcon from '@mui/icons-material/Home';
import AccountCircleIcon from '@mui/icons-material/AccountCircle';
import FilterListIcon from '@mui/icons-material/FilterList'; // Importa o ícone de filtro
import SearchIcon from '@mui/icons-material/Search';
import { useNavigate } from 'react-router-dom'; // Certifique-se de que está usando o hook de navegação

export function HomePage() {
    const navigate = useNavigate(); // Definição do navigate para navegação

    return (
        <Box>
            {/* Mantém o HeaderComponent */}
            <HeaderComponent />

            {/* Novo conteúdo para adicionar ícones e divisão */}
            <Box
                sx={{
                    display: 'flex',
                    ...
                    alignItems: 'center',
                    padding: '0 1rem',
                    borderBottom: '1px solid #000000', // Linha de divisão
                    marginTop: '-80px', // Compensa altura para alinhar com logo
                }}
            >
                {/* ÍCONE DE HOME */}

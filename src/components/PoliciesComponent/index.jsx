...
export function PoliciesComponent() {
    ...
    return (
        <>
            ...
            >
                <Button variant="text" sx={{ color: 'white' }} onClick={() => handleClickOpen('policies')}>
                    POLITICAS
                </Button>

                <Divider orientation="vertical" flexItem variant="middle" />
                <Button variant="text" sx={{ color: 'white' }} onClick={() => handleClickOpen('terms')}>
                    TERMOS DE USO
                </Button>

                <Divider orientation="vertical" flexItem variant="middle" />
                <Button variant="text" sx={{ color: 'white' }} onClick={() => handleClickOpen('lgpd')}>
                    LGPD
                </Button>
            </Box>
